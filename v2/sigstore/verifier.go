...
// Verifier validates Sigstore bundles.
...
// Verify validates a signature against the given manifest.
func (v *Verifier) Verify(ctx context.Context, manifestDigest digest.Digest, payload []byte, sig *Signature) error {
	var b bundle.Bundle
