...
// Signer creates Sigstore bundles for manifest signing.
type Signer struct {
...
// Sign creates a signature for the given manifest.
func (s *Signer) Sign(ctx context.Context, manifestDigest digest.Digest, payload []byte) (*Signature, error) {
