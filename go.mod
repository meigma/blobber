module github.com/meigma/blobber

go 1.25.0

// TODO: Remove replace directive before release and use proper version
replace github.com/meigma/blobber/sigstore => ./sigstore
